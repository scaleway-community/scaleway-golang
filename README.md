# Official Golang image on Scaleway

[![Travis](https://img.shields.io/travis/scaleway/image-app-golang.svg)](https://travis-ci.org/scaleway/image-app-golang)
...
Scripts to build the official Golang image on Scaleway
