...
ENV GOARCH=arm GOOS=linux GOLANG_VERSION=1.5.3 GOROOT=/usr/local/go GOPATH=/go
...
&& echo "Installing Golang 1.5.3 Using go1.4.2" \
 ...
 && echo '754e06dab1c31ab168fc9db9e32596734015ea9e24bc44cae7f237f417ce4efe go1.5.3.src.tar.gz' | sha1sum -c \
